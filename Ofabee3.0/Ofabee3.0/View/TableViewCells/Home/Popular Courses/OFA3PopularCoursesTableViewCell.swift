//
//  OFA3PopularCoursesTableViewCell.swift
//  Ofabee3.0
//
...
class OFA3PopularCoursesTableViewCell: UITableViewCell {

    @IBOutlet weak var labelCourseTitle: UILabel!
    @IBOutlet weak var imageViewCourse: UIImageView!
    @IBOutlet weak var viewInnerPopularCourse: UIView!
    ...
    func customizeCellWithDetails(imageURL:String,courseTitle:String,categories:NSArray,ratingValue:String,ratingCount:String,isBundle:Bool,courseOriginalPrice:String,courseDiscountPrice:String,freeStatus:String){
        self.imageViewCourse.sd_setImage(with: URL(string: imageURL)!, placeholderImage: UIImage(named: ""), options: .progressiveLoad, context: nil)
        self.labelCourseTitle.text = courseTitle
        
        self.viewInnerPopularCourse.layer.cornerRadius = 4.0
        ...
        self.labelCourseDiscountPrice.text = "\(ruppeeSymbol) "+courseDiscountPrice
